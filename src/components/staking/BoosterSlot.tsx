...
export function BoosterSlot({ booster, onClick, showNFTImage = true }: BoosterSlotProps) {
                    ...
                    <div className="z-10 text-center p-2 flex flex-col justify-end h-full">
                        <div className="mt-auto">
                            <div className="flex items-center justify-center gap-1 mb-1">
                                <span className="text-lg drop-shadow-lg">{getBoosterIcon(booster.type)}</span>
                            ...
                            <div className="text-white/80 text-xs font-semibold drop-shadow-lg">
                                ×{booster.multiplier.toFixed(2)} Multiplier
                            </div>
