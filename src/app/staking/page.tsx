...
function StakingPage() {
  ...
  const handleStake = (amount: number) => {
    ...
    toast.success(`Simulated Stake: ${amount} MKIN`);
  };
  ...
  const handleUnstake = (amount: number) => {
    ...
    toast.success(`Simulated Unstake: ${amount} MKIN`);
  };
  ...
  const handleClaim = () => {
    ...
    toast.success(`Claimed ${miningData.unclaimedRewards.toFixed(4)} MKIN!`);
  };
    ...
    <div className="relative min-h-screen bg-[#050302] text-[#f4c752] font-sans selection:bg-[#f4c752] selection:text-black">
      ...
      <header className="lg:hidden mx-auto w-full max-w-7xl px-6 pt-8 pb-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3">
          ...
          <span className="font-bold text-sm tracking-widest uppercase text-[#f4c752]">Realmkin</span>
        </Link>
        <button
      ...
      <main className="w-full max-w-7xl mx-auto my-10 px-6 lg:px-10 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 space-y-8">
            <MiningConsole
              stakingRate={miningData.stakingRate}
              unclaimedRewards={miningData.unclaimedRewards}
              onClaim={handleClaim}
            />
          ...
          <div className="lg:col-span-3 flex flex-col-reverse lg:flex-col gap-6">
            ...
            <div className="bg-black/40 border border-[#f4c752]/20 rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                {miningData.boosters.map(booster => (
